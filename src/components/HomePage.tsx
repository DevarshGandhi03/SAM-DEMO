    ...
    <div className="relative flex flex-col items-center justify-center prose">
      ...
      <Gallery columns={2} fullWidth>
        <Video
          ...
          reactCaption={
            <>
              SAM can take input prompts from other systems, such as in the
              future taking a user's gaze from an AR/VR headset to select an
              object. This footage uses our{" "}
              <a
                className="font-bold text-blue-600 hover:underline active:underline"
                href="https://about.meta.com/realitylabs/projectaria/datasets/"
                target={"_blank"}
              >
                open sourced Aria pilot dataset
              </a>
              .
            </>
          }
      ...
      <Content spaceTop spaceBottom color="gray" centered>
        <FeatureSummary centerAlign useNavLink label="Demonstration">
          ...
          <Button className="my-5 text-lg font-bold" ref={buttonRef}>
